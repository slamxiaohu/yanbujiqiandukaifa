...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        # self.det_thread.send_img3.connect(lambda x: self.show_image(x, self.out_video3))
        # self.det_thread.send_img4.connect(lambda x: self.show_image(x, self.out_video4))
